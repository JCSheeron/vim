...
set wrap
" turn off wrapping for python files and text files
au BufRead,BufNewFile *c,*.cpp,*.h set textwidth=120
au BufRead,BufNewFile *py,*.pyw set textwidth=120
" set wrapping to 80 for text and markdown
au FileType text,markdown set textwidth=82
...
au FileType text,markdown set tabstop=4
au FileType text,markdown set shiftwidth=4
au FileType text,markdown set softtabstop=4
